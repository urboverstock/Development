...
Route::group(['middleware' => ['auth'], 'prefix' => 'buyer'], function () {
    ...
    Route::any('reorder/{orderId}', [App\Http\Controllers\Buyer\OrderController::class, 'reOrder'])->name('buyerReOrder');
...
Route::post('remove-follow-user', [App\Http\Controllers\LandingController::class, 'removeFollowUser'])->name('remove-follow-user');
