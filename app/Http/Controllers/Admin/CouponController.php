...
class CouponController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.coupon.couponList', $data);
    }
    ...
    public function store(CouponStoreRequest $request)
    {
        ...
        if($coupon->save()){
            return redirect()->route('adminCoupon')->with('success', 'Coupon added successfully');
        }else{
    ...
    public function delete($id)
    {
        ...
        if($coupon->delete())
        {
            return redirect()->route('adminCoupon')->with('success', 'Coupon deleted successfully');
        }
        else
        {
            return redirect()->back()->with('error', COMMON_ERROR);
