...
<div class="mt-96 inner-profile-header bg-primary-lighten-2 pb-3"> 
    ...
    @endif
		<div class="d-flex align-items-center flex-wrap me-4 mb-4">
			...
			<button type="button" class="btn btn-dark rounded-pill px-3 mb-lg-0 mb-3 d-flex align-items-center add-follow-user" data-userid="{{ $user->id }}">
			...
			@if(count($categories) > 0)
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="card product-item border-0 shadow br-12 mb-5">
						...
						<a href="{{ route('get-collectionproducts', $category->id) }}"><h5 class="fw-bold">{{$category->name}}</h5></a>
