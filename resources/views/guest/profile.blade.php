  ...
  <img class="logged-wave-img position-absolute" src="{{ asset('assets/images/wave-logg-seller.png') }}" alt=""> <img class="img-fluid header-big-avatar mb-lg-0 mb-4" data-aos="zoom-in-up" src="../assets/images/big-avatar.png" alt="">
	...
	<div class="inner-profile-header-content">
		...
		<div class="d-flex align-items-center flex-wrap me-4 mb-4">
			...
			<button type="button" class="btn btn-dark rounded-pill px-3 mb-lg-0 mb-3 d-flex align-items-center">
		...
		<div class="center-guest-buyers ">
			<div class="my-4 mx-4">
				<div class="card border-0 shadow br-20">
					<div class="card-body d-flex align-items-center flex-wrap p-5"> <img class="me-3" src="../assets/images/section-7/1.png" alt="">
						<div class="text-24 fw-bold">Teresa Hodge</div>
					</div>
				</div>
			</div>
			<div class="my-4 mx-4">
