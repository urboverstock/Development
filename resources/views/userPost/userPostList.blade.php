...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-12 mb-5">
                <div class="bg-chat br-10 p-3">
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="custom-form-group-search position-relative col-12 ">
                        	<form class="d-flex" method="get" action="{{ route('buyerUserPost') }}">
                    ...
                    <tr>
                      ...
                      <td class="py-3 align-middle">
                        <div class="d-flex align-items-center">
                          <a class="me-2 hover-primary text-decoration-none" href="{{ route('buyerEditUserPost', \Illuminate\Support\Facades\Crypt::encrypt($userPost['id'])) }}">
                          ...
                          <a class="me-2 hover-primary" href="{{ route('buyerDeleteUserPost', \Illuminate\Support\Facades\Crypt::encrypt($userPost['id'])) }}"><i class="fas fa-trash-alt"></i></a>
                          <a class="me-2 hover-primary" href="{{ route('buyerViewUserPost', \Illuminate\Support\Facades\Crypt::encrypt($userPost['id'])) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
