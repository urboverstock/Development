            ...
            <div class="quantity-field rounded-pill border d-flex align-items-center mb-3 me-4" >
              <button 
                ...
                <svg width="14" height="15" viewBox="0 0 18 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.970703 0.209473H17.8388V3.76558H0.970703V0.209473Z" fill="#000"/>
                </svg>                  
              </button>
         ...
         <div class="col-lg-12">
            ...
            <div class="tab-content px-4" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="nav-rating" role="tabpanel" aria-labelledby="nav-contact-tab">
                ...
                <form id="reviewform" method="post" action="{{route('buyerReviewSubmit')}}">
                  {{ csrf_field() }}
                  <input type="hidden" id="rating" name="rating" value="5">
                  <input type="hidden" name="product_id" value="{{$product_details->id}}">
                    <ul class="star-list d-flex list-unstyled">
                  ...
                  <textarea class="form-control form-control-lg mb-4 py-3" type="text" placeholder="Comment" aria-label="" name="comment" value="{{ old('comment') }}" required=""></textarea>
                  <span class="error">{{ $errors->first('comment') }}</span>

                  <div class="d-grid mb-3">
                    <button type="submit" class="btn btn-dark shadow py-3 fw-bold btn-lg">Submit</button>
                  </div>
                </form>
