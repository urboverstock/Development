  ...
  <section id="z-faq" class="py-0">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
         <img class="img-fluid" src="{{ asset('assets/images/svg/faq.svg') }}" alt="">
        </div>
        <div class="col-lg-6">
        <div class="accordion accordion-flush" id="accordionExample">
            @foreach($faqs as $faq) 
              <div class="accordion-item">
                ...
                <div id="collapse_{{ $faq->id }}" class="accordion-collapse collapse show" aria-labelledby="heading_{{ $faq->id }}" data-bs-parent="#accordionExample">
