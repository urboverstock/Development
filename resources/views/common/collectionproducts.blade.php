...
@section('content')
  ...
  <section class="pb-5">
    <div class="container-xl">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card product-item border-0 shadow-sm mb-5">
                        <div class="card-body ">
                            ...
                            <a href="{{ route('product-detail', $product->sku) }}"><h5 class="fw-bold text-one-line">{{$product->name }}</h5></a>
      ...
      @if(count($products) >= 8)
       <div style="display:none;"><button type="button" class=" btn btn-dark rounded-pill px-4 py-3 d-flex m-auto loadmoreproductsbtn">Load More Products</button>
      </div>
      @endif
      @else
