              ...
              @foreach($user['products'] as $key => $product)
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card product-item border-0 br-12 shadow mb-5">
                    <div class="card-body ">
                      <img class="img-fluid mb-3 br-12" src="{{ !empty($product['product_image']['file_path']) ? $product['product_image']['file_path'] : asset('assets/images/default.png') }}" alt="" style="height: 170px;">
