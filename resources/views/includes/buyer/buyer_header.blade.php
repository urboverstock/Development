    ...
    <nav class="navbar navbar-expand-lg navbar-fixed-top navbar-light fixed-top bg-white">
      <div class="container-fluid px-5">
        ...
        <div class="custom-form-group-search position-relative 	d-none d-lg-block">
          <form class="d-flex position-relative" action="{{ route('search-products') }}">
            <input type="text" class="form-control" placeholder="Search for your favourite brands" value="{{ request()->get('searchproduct') }}" required name="searchproduct" />
            <button type="submit" class="btn transparent-button position-absolute top-50 end-0 translate-middle"><i class="fas fa-search text--primary pe-0" style="top:35%"></i></button>
          </form>
        </div>
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item border-bottom " @if((request()->segment(3) == 'savelater')) style="font-weight: bold !important;" @endif href="{{ route('buyerSaveLaterProduct') }}">Save to later</a></li>
              <li><a class="dropdown-item border-bottom " @if((request()->segment(3) == 'wishlist')) style="font-weight: bold !important;" @endif href="{{ route('buyerWishlistProduct') }}">My Wishlist</a></li>
