...
@section('content')
    ...
    <section class="p-0">
    <div class="box-wrapper" style="margin-top:0px;">
        <div class="box-sidebar">
            ...
            @foreach($users as $key => $user)
                ...
                <div class="box-item {{$user->id == $userId ? 'active' : ''}}">
                  <a href="{{ url('/admin/chat?user_id='.  \Illuminate\Support\Facades\Crypt::encrypt($user->id)) }}" class="py-3 d-flex align-items-start text-decoration-none text-dark">
                  @if(@$user->profile_pic)  
            ...
            // {
                ...
                socket.on('sendChatToClient', function(data) {
                    ...
                    else
                    {
                        ...
                        $.ajax({
                            type: "GET",
                            url: baseUrl + "/admin/unreadMessage",
