          ...
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap mb-3">
              <div class="d-flex align-items-center flex-wrap">
                <h4 class="mb-0 me-4">Seller List</h4>
                    ...
                    <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <span class="text-dark-admin text-truncate product-list-text">{{ $seller['first_name'] }} {{ $seller['last_name'] }}</span>
                          </div>
                        </td>
                        <td>{{ $seller['email'] }}</td>
                        ...
                        <td>
                          ...
                          @if($seller['status'] == 1)
                            <a class="me-2 btn btn-sm btn--primary text-decoration-none" href="{{route('admin.buyer.status',[base64_encode($seller['id']), base64_encode(0)])}}" onClick="return confirm('Are you sure you want to deactivate this user?')">
                              Deactivate
                            </a>
                          @else
                            <a class="me-2 btn btn-sm btn--primary text-decoration-none" href="{{route('admin.buyer.status',[base64_encode($seller['id']), base64_encode(1)])}}" onClick="return confirm('Are you sure you want to activate this user?')">
                              Activate
                            </a>
                          @endif
                        </td>
