          ...
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap mb-3">
              <div class="d-flex align-items-center flex-wrap">
                <h4 class="mb-0 me-4">Advertisements List</h4>
              ...
              <table id="myTable" class="display product-table" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="row" class="py-3 align-middle f-400"><img src="{{ url('/') . $advertisement['banner'] }}" class="img-fluid" width="200"></td>
                          ...
                          <div class="dropdown admin-btn-dropdown">
                            ...
                            >
                              ...
                              @if($advertisement['status'] == 1)
                                <li>
                                  <a class="dropdown-item" href="{{route('admin.advertisement.status',[base64_encode($advertisement['id']), base64_encode(0)])}}" onClick="return confirm('Are you sure you want to deactivate this advertisements?')">Deactivate</a>
                                </li>
                              @else
                                <li><a class="dropdown-item" href="{{route('admin.advertisement.status',[base64_encode($advertisement['id']), base64_encode(1)])}}" onClick="return confirm('Are you sure you want to activate this advertisements?')">Activate</a></li>
                              @endif
