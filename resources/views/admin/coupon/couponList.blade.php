        ...
        <div class="row">
            <div class="col-lg-12 mb-5">
                <span class="float-right">
                	<a href="{{route('adminAddCoupon')}}" class="btn btn-dark mb-3 rounded-pill fw-bold px-5 py-3 mb-1 aos-init aos-animate" data-aos="fade-up">Add Coupon 
                  </a>
                ...
                <div class="bg-chat p-3 br-12">
                    <div class="d-flex justify-content-center flex-wrap">
                        <div class="custom-form-group-search  position-relative col-12 ">
                        	<form class="d-flex" method="get" action="{{ route('adminCoupon') }}">
	                            <input type="text" class="form-control mw-100" placeholder="Search Coupons" name="search">
                ...
                <table class="table table-borderless">
                  <thead class="bg-chat">
                    <tr>
                      ...
                      <th scope="col" class="fw-normal py-3">Name</th>
                      <th scope="col" class="fw-normal py-3">Type</th>
                      <th scope="col" class="fw-normal py-3">Price</th>
                      <th scope="col" class="fw-normal py-3">Start Date</th>
                      <th scope="col" class="fw-normal py-3">End Date</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a class="text-decoration-none text-dark me-2" href="{{ route('adminEditCoupon', \Illuminate\Support\Facades\Crypt::encrypt($coupon['id'])) }}">
                          ...
                          <a class="text-decoration-none text-dark fs-5" href="{{ route('adminDeleteCoupon',  \Illuminate\Support\Facades\Crypt::encrypt($coupon['id'])) }}"><i class="fas fa-trash-alt"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
