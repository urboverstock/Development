...
<section class="mt-90 ">
    <div class="container">
      @if(!isset($coupon))
      <form method="post" action="{{ route('adminStoreCoupon') }}" enctype="multipart/form-data" id="add_coupon_form">
      @else
      <form method="post" action="{{ route('adminUpdateCoupon') }}" enctype="multipart/form-data" id="add_coupon_form">
