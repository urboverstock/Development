                ...
                <div class="bg-chat p-3 br-12">
                    <div class="d-flex justify-content-center flex-wrap">
                        <div class="custom-form-group-search  position-relative col-12 ">
                        	<form class="d-flex" method="get" action="{{ route('sellerCoupon') }}">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a class="text-decoration-none text-dark me-2" href="{{ route('sellerEditCoupon', \Illuminate\Support\Facades\Crypt::encrypt($coupon['id'])) }}">
                          ...
                          <a class="text-decoration-none text-dark fs-5" href="{{ route('sellerDeleteCoupon',  \Illuminate\Support\Facades\Crypt::encrypt($coupon['id'])) }}"><i class="fas fa-trash-alt"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
