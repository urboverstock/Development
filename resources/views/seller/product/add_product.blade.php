...
<section class="mt-90 ">
    <div class="container">
      @if(!isset($product))
      <form method="post" action="{{ route('sellerAddProduct') }}" enctype="multipart/form-data" id="add_product_form">
      @else
      <form method="post" action="{{ route('sellerEditProduct', $product->id) }}" enctype="multipart/form-data" id="add_product_form">
      @endif
              {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12">
