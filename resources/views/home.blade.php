              ...
              <div class="card sec-7-card border-0 shadow">
                <div class="card-body">
                  <div class="d-flex align-items-center sec-7-card-sm-title flex-wrap">
                    <img class="img-fluid me-2" src="{{ asset('assets/images/section-7/1.png') }}" alt="">
                  ...
                  <div class="sec-7-card-lg-title">
                    ...
                    <div>
                      <h6 class="fw-bold text-white">Irish artist surviving online ⁣ vintage, 
                        reworking & drawing a sad man ⁣⁣⁣ I made
                        a documentary about my life, ok</h6>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="items">
              <div class="card sec-7-card border-0 shadow">
                <div class="card-body">
                  ...
                  <div class="sec-7-card-lg-title">
                    <div class="d-flex align-items-center border-bottom flex-wrap py-3">
                      <img class="avatar me-3" src="{{ asset('assets/images/section-7/1.png') }}" alt="">
                      <div class="me-3">
                        <p class="fw-bold mb-1 text-white">Teresa Hodge</p>
                        <div class="d-flex">
              ...
              <div class="card sec-7-card border-0 shadow">
                <div class="card-body">
                  ...
                  <div class="sec-7-card-lg-title">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap my-4 flex-wrap">
                      <h6 class="mb-0 fw-bold text-white">247k Followers</h6>
                      <button type="button" class="btn btn-dark shadow-0 border-0 px-3 rounded-0">Follow</button>
                    </div>
                    <div>
